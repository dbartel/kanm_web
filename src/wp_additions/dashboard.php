...
function admin_greeting()
{
	echo "<p>You are an admin.
			Review or add new posts by navigating to Posts on the right.</p>
			<p><strong>Be sure to tag Frequency posts as <i>frequency</i> and announcements as <i>announcements</i></strong>
			</p>";
}

function normal_greeting()
{
	echo "<p>Write new posts by navigating to posts on the right.
			Once you submit an article, it will be reviewed by an officer who will then submit or reject it.
			</p>";	
}
...
/*	if ( is_network_admin() )
	...
	if ( is_blog_admin() ) {
		...
		{
			wp_add_dashboard_widget( "custom_help_widget", "Welcome", "admin_greeting");
			wp_add_dashboard_widget( 'dashboard_activity', __( 'Activity' ), 'wp_dashboard_site_activity' );
		}
		else
		{
			wp_add_dashboard_widget( "custom_help_widget", "Welcome", "normal_greeting");
		}
	}
